...
*   **恶劣天气提醒**
    ...
    *   *提供商：* 美国国家气象局 (NWS)，MeteoGate（欧洲），中国气象局（CMA），韩国气象厅（KMA），日本气象厅（JMA），加拿大环境与气候变化部（ECCC），与 WMO 相关的公共资源，以及类似的公共警报源
*   **地震警报**
...
**例外 —— 仅限 Research Array：** 如果您选择加入（见下文），Wingdings 可能会收到您选择贡献的有限事件报告。该路径不是广告分析；它是一项由您控制、可随时关闭的可选研究贡献。
