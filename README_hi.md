...
एक ऑन-डिवाइस क्लासिफ़ायर सैकड़ों रोज़मर्रा की आवाज़ें पहचानता है और महत्वपूर्ण श्रेणियाँ देखता है — **सायरन, अलार्म — जिसमें एक समर्पित कार-अलार्म क्लास शामिल है — डोरबेल/दस्तक, बच्चे का रोना, पास कोई व्यक्ति, और गंभीर मौसम।** जब कोई फायर होता है, आपको साफ़ ऑन-स्क्रीन अलर्ट, वैकल्पिक **पुश नोटिफ़िकेशन**, और एक अलग **हैप्टिक** मिलता है — भले ऐप बैकग्राउंड में हो या फ़ोन सो रहा हो। महत्वपूर्ण श्रेणियाँ डिफ़ॉल्ट रूप से तैयार रहती हैं, ताकि नोटिफ़िकेशन चालू करने का मतलब “सब बंद” न हो। सभी अलर्ट श्रेणियाँ बंद करें तो बैकग्राउंड में इंजन पूरी तरह हाइबरनेट हो जाता है — बैटरी बचाने के लिए। एक **Sentinel** लेयर अलर्ट को स्वतंत्र सबूतों — दिशा, मोशन, और सार्वजनिक फ़ीड — से क्रॉस-चेक करती है, ताकि जो फायर हो वह पुष्टि किया हुआ हो, अकेला क्लासिफ़ायर अंदाज़ा नहीं। यह दोनों तरफ़ काम करता है: गाने के अंदर सायरन जैसी आवाज़ रोकी जाती है, लेकिन आपके म्यूज़िक से बार-बार गुज़रने वाला असली सायरन टूटकर अलर्ट देता है।

गंभीर-मौसम चेतावनियाँ आधिकारिक सार्वजनिक फ़ीड से आती हैं — अमेरिका **NWS**, यूरोप **MeteoGate**, **China CMA**, **Korea KMA**, **Japan JMA**, **Canada ECCC**, **Australia BOM**, और **Brazil INMET** — सभी उपयोगकर्ताओं के लिए मुफ़्त। फ़ीड आपके स्थान को कवर करने वाली तक सीमित की जाती हैं। जापान में ऐप JMA के **अग्रिम बुलेटिन** भी पढ़ता है — टाइफ़ून या भारी बारिश से दिनों पहले जारी सादे-भाषा नोटिस, सिर्फ़ ख़तरा आने के बाद की चेतावनियाँ नहीं — साथ ही अचानक मूसलधार और लैंडस्लाइड बुलेटिन। अग्रिम नोटिस शांति से दिखाए जाते हैं, असली चेतावनी के लिए आरक्षित आवाज़ और कंपन के बिना।
...
Speaker Mode चालू होने पर, जब पास कोई व्यक्ति दूसरी भाषा बोलता है, Vigilant Ear उसे पहचान सकता है और उनके कैप्शन **आपकी भाषा में** दिखा सकता है, स्रोत भाषा उनके ब्लॉक पर दिखती है। श्रृंखला — सुनो → स्पीकर अलग करो → ट्रांसक्राइब → अनुवाद → दिखाओ — **डिवाइस पर** चलती है; नेटवर्क का एकमात्र पल Apple से एक बार भाषा-पैक डाउनलोड है। आपको पहले दूसरी भाषा जानने या चुनने की ज़रूरत नहीं।

यह शिपिंग में **साइंस फ़िक्शन के यूनिवर्सल ट्रांसलेटर** के सबसे क़रीब की चीज़ है — वह डिवाइस जो बस समझ लेता है। Vigilant Ear भाषा खुद पहचानता है, कमरे में हर स्पीकर का पीछा करता है, और सबको आपकी भाषा में कैप्शन करता है — न ईयरबड, न सेटअप, आपके डिवाइस पर।

```mermaid
graph LR
    A["बस सुनो"] --> B["भाषा अपने आप पहचानी गई"] --> C["हर आवाज़ अलग"] --> D["पूरा कमरा आपकी भाषा में कैप्शन"]
```
...
टाइटल रेल पर कैमरा पिल खोलें और पहचानी आवाज़ों को लाइव कैमरा व्यू में उनकी असली दिशा पर पिन करें। मार्कर स्पीकर या साउंड श्रेणी और दिशा के हिसाब से क्लस्टर होते हैं ताकि व्यू पढ़ने लायक रहे; स्रोत चुप होने पर एज-फ़ेड हो जाते हैं।
...
- **Standing Watch** — कमरे की अपनी स्थिति, हमेशा ऑन, कॉन्फ़िगर करने को कुछ नहीं: कमरा अपना पैटर्न रखे तो स्थिर स्यान लैंप, कुछ बदले — नई आवाज़, अचानक सन्नाटा, या कुछ पास आना — तो एम्बर।
- **गंभीर-मौसम अलर्ट** — आपके क्षेत्र के लिए NWS, MeteoGate (यूरोप — हमारे 15-मिनट अलर्ट कैश से ताज़ा), CMA, KMA, JMA (जापान), ECCC (कनाडा), BOM (ऑस्ट्रेलिया), INMET (ब्राज़ील)।
...
किसी एक मॉडल पर अकेले भरोसा नहीं। **Sentinel** लेयर डिटेक्शन और अलर्टिंग के बीच बैठती है: स्वतंत्र इंजन फ़्रेम-बाय-फ़्रेम एक-दूसरे की पुष्टि या वीटो करते हैं — और जब दोहराया वास्तविक सबूत वीटो के ख़िलाफ़ जमा हो (आपके म्यूज़िक से गुज़रता असली सायरन), सबूत जीतता है और अलर्ट फायर होता है।
...
```mermaid
graph LR
    P1["Vigilant Ear<br/>आपके डिवाइस पर"] --> W["Wingdings अलर्ट कैश<br/>एक साझा कॉपी · 15-मिनट रिफ़्रेश"]
    W --> N["आधिकारिक सार्वजनिक फ़ीड<br/>NWS · MeteoGate · JMA · KMA · CMA<br/>ECCC · BOM · INMET · USGS"]
```
...
**दिशा — लगभग एक डिग्री।** आवाज़ टॉप माइक्रोफ़ोन तक बॉटम से कुछ सौ माइक्रोसेकंड पहले पहुँचती है, या बाद में (एक सेकंड के कुछ सौ मिलियनवें हिस्से)। उस छोटे अंतराल से ऐप निकालता है कि फ़ोन की लंबी धुरी से आवाज़ कितनी दूर है, और वह आपके आगे है या पीछे। इंजीनियर इसे **TDOA** कहते हैं — *Time Difference of Arrival* (आगमन का समय अंतर): अंतराल मापो, बियरिंग बनाओ। यहीं हम यही करते हैं।

| हमने क्या मापा | परिणाम |
|---|---|
| रीडिंग का सेकंड-दर-सेकंड डगमगाना | iPhone 17 पर 0.6° · 16 Pro Max पर 1.5° |
| मापा आगमन अंतराल बनाम टेप मेज़र | 4 mm के भीतर |
| प्रति सेकंड चार पर इस्तेमाल योग्य रीडिंग (डेस्क सेंसस) | 98% |
| 96 सिम्युलेटेड कमरों में मीडियन एरर — शांत ऑफ़िस से सख़्त दीवारों वाले कमरे तक, जहाँ शोर लगभग आवाज़ जितना तेज़ हो (5 dB SNR) | 1.0° |

*यह क्यों मायने रखता है:* अगर आप सायरन नहीं सुन सकते, “आपके पीछे, एक तरफ़” बताता है कहाँ देखें — और जो रीडिंग स्थिर रहे, उस पर भरोसा किया जा सकता है।
...
- **iPad (नेटिव)।** एडैप्टिव लेआउट: बड़ी स्क्रीन पर लाइव कैप्शन को मैप के बगल में पारदर्शी पैनल मिलता है जो बात न होने पर सिमट जाता है। सिंगल-चैनल माइक → पूरी दिशा के बिना कैप्शन।
...
- **Android.** अलग बिल्ड कोर रडार, अलर्ट, कैप्शन, और मौसम के साथ; Constellation मेश iOS-पहले है। Android पैरिटी बढ़ने पर प्रोडक्ट साइट अपडेट देखें।

**वर्तमान App Store संस्करण:** 1.1.2। आधुनिक iOS के लिए बना (SpeechAnalyzer युग)।
