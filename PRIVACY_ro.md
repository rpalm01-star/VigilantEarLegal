...
**Data de intrare în vigoare:** 18 septembrie 2026
...
*   **Alerte de vreme severă (prin propriul nostru serviciu de alerte)**
    ...
    *   *Furnizor:* Date oficiale de la U.S. National Weather Service (NWS), MeteoAlarm / MeteoGate (Europa), China Meteorological Administration (CMA), Korea Meteorological Administration (KMA), Japan Meteorological Agency (JMA), Environment and Climate Change Canada (ECCC), INMET din Brazilia, Bureau of Meteorology din Australia (BoM) și National Disaster Management Authority din India (NDMA) — livrate telefonului tău prin infrastructură pe care o operăm.
