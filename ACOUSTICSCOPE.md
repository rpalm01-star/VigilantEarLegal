...
The training and import half — including the **mandatory Background class** and the gating that prevents false alarms — is covered step-by-step in the **[Custom Sound Packs guide](https://vigilantear.com/en/byom/)**.
