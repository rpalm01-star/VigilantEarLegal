...
| **Parziali** | I toni prominenti seguiti nel tempo come linee colorate, ciascuna etichettata con la sua nota musicale. Ottimo per fischi, sirene, canto degli uccelli e ronzii di macchinari. |
...
La parte di addestramento e importazione — inclusa la **classe Background obbligatoria** e il controllo che evita i falsi allarmi — è spiegata passo passo nella **[guida ai Pacchetti di Suoni Personalizzati](https://raw.githubusercontent.com/rpalm01-star/VigilantEarLegal/main/BYOM_it.md)**.
...
- **Il titolo del brano cavalca un globo** — una volta riconosciuto il brano, il suo titolo avvolge
  l'equatore di un globo invisibile che attraversa la scena, e l'artista occupa l'angolo in alto a
  destra.
...
telefono e il televisore segue: lo stesso Mirror mette quindi lo Spettrogramma o il Visualizzatore
sulla parete.
