...
```mermaid
graph TD
    A["Prise micro stéréo"] --> B["Porte de sous-échantillonnage 16 kHz"]
    B --> C["Classificateur de sons (Apple Neural Engine)"]
    B --> D["TDOA / formation de voies → relèvement et distance"]
    ...
    C & D & F & G --> H["Anneau radar · sous-titres · carte · alertes"]
```
