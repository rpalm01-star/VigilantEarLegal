...
악천후 경보는 공식 공공 피드에서 가져옵니다 — 미국 **NWS**, 유럽 **MeteoGate**, **중국 CMA**, **한국 KMA**, **일본 JMA**, 그리고 **캐나다 ECCC** — 모든 사용자에게 무료로 제공됩니다. 피드는 사용자가 있는 위치를 커버하는 것으로 좁혀집니다.
...
- **악천후 경보** — 해당 지역의 NWS, MeteoGate, CMA, KMA, JMA(일본), ECCC(캐나다).
...
**현재 App Store 버전:** 1.0.17. 최신 iOS (SpeechAnalyzer 시대)를 위해 빌드되었습니다.

---

## 지역화

인터페이스, 알림 및 자막 등 완전히 지역화되어 **영어, 스페인어, 포르투갈어(브라질), 프랑스어, 독일어, 아랍어, 일본어, 중국어(간체), 한국어, 러시아어** (10개 언어)로 제공됩니다. 시스템 로케일 또는 앱 내 수동 선택을 따릅니다.
