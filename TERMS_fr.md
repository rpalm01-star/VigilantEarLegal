...
L'Application peut ne pas détecter tous les sons, et les estimations directionnelles sont approximatives. **Utilisez toujours votre propre confirmation visuelle et votre jugement.** Ne comptez jamais uniquement sur cette Application pour votre sécurité.

## 4. Aucune garantie

L'APPLICATION EST FOURNIE "TELLE QUELLE" ET "SELON LA DISPONIBILITÉ" SANS AUCUNE GARANTIE D'AUCUNE SORTE, EXPRESSE OU IMPLICITE, Y COMPRIS, MAIS SANS S'Y LIMITER, LES GARANTIES DE QUALITÉ MARCHANDE, D'ADÉQUATION À UN USAGE PARTICULIER ET DE NON-CONTREFAÇON.

NOUS NE GARANTISSONS PAS QUE L'APPLICATION SERA ININTERROMPUE, EXEMPTE D'ERREURS OU COMPLÈTEMENT PRÉCISE.
...
- Ne pas compter sur l'Application comme seul moyen de conscience situationnelle
- Garder l'Application mise à jour avec la dernière version
- Signaler tout bug ou problème que vous rencontrez
...
Ces Conditions seront régies et interprétées conformément aux lois de l'État de **Floride**, sans tenir compte de ses dispositions en matière de conflits de lois.
