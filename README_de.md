...
graph TD
    ...
    B --> C["Geräusch-Klassifikator (Apple Neural Engine)"]
    B --> D["TDOA / Beamforming → Peilung & Entfernung"]
    B --> E["Sprecher-Diarisierung (WeSpeaker, ANE) → wer"]
    E --> F["Spracherkennung (SpeechAnalyzer) → Wörter"]
    F --> G["On-Device-Übersetzung → Ihre Sprache"]
    C & D & F & G --> H["Radar · Untertitel · Karte · Warnungen · Watch · Live-Aktivität · AR"]
```
...
**Aktuelle App-Store-Version:** 1.0.11. Gebaut für modernes iOS (SpeechAnalyzer-Ära).
