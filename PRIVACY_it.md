...
*   **Remote Link (facoltativo — avviare un collegamento richiede Power Pack+; unirsi è gratuito)**
    ...
    *   *Cosa viene inviato:* **Nessun audio, in nessun momento** — una sessione Remote Link non contiene alcuna traccia audio. Il video in diretta e il testo digitato viaggiano **direttamente tra i due telefoni** dove le reti lo consentono, cifrati end-to-end. Per stabilire il collegamento, il nostro servizio conserva brevemente un codice d'invito di breve durata insieme ai dettagli tecnici che i due telefoni usano per trovarsi. Quella casella non contiene **né video né testo**, e scade entro un'ora.
