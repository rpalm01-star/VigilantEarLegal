...
- **地震アラート (USGS、全世界)** — 近くで地震が報告されると、振動でお知らせし、揺れが感じられた地域を地図上に表示します。公式 USGS フィードによる確認情報であり、早期警報ではありません。揺れを感じたとき、それが何だったのかを教えてくれます。
...
**現在の App Store バージョン:** 1.0.9。最新の iOS (SpeechAnalyzer 時代) 向けに構築されています。
