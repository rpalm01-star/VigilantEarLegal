...
Приложение, созданное специально для сообщества глухих и слабослышащих. Большинство приложений распознавания звука говорят, *что* это за звук. **Vigilant Ear говорит, где он, кто его издаёт и что говорят** — превращая iPhone в «звуковой трикордер» реального времени, который описывает акустику вокруг вас.
...
- 👁️ **Сделано для глухих / слабослышащих.** Различимая тактильная отдача, высокий контраст, подсказки без опоры только на цвет, крупные зоны нажатия и уважение к Reduce Motion.

---

## Для кого это

- **Глухие и слабослышащие пользователи**, которым нужна ситуационная осведомлённость о звуке — Home Watch (стук, сигнализация, ребёнок, телефон) и Street Watch (сирена, приближение), которые можно оставить включёнными и которым можно доверять.
...
Предупреждения о суровой погоде приходят из официальных публичных лент — **NWS** (США), **MeteoGate** (Европа), **CMA** (Китай), **KMA** (Корея), **JMA** (Япония) и **ECCC** (Канада) — бесплатно для всех. Ленты сужаются до тех, что покрывают ваше местоположение.
...
### ♿ Сначала доступность
Сделано для глухих / слабослышащих и пользователей с нарушением цветовосприятия: **не завязанные только на цвет** подсказки, зоны нажатия **≥44 pt**, уважение к **Reduce Motion**, мультимодальные оповещения (тактильность + визуал + Watch) и экран стартовой проверки разрешений с ясными зелёным / серым / красным (и жжёно-оранжевым «запрещено») состояниями — включая разрешение уведомлений как главный выключатель оповещений.
...
- **Оповещения о суровой погоде** — NWS, MeteoGate, CMA, KMA, JMA (Япония), ECCC (Канада) для вашего региона.
...
- **iPhone (полный опыт).** Для пеленгации нужны стереомикрофоны. Рекомендуется **iPhone 13 или новее**.
...
**Текущая версия App Store:** 1.0.13. Собрано для современного iOS (эпоха SpeechAnalyzer).

---

## Локализация

Полностью локализованы интерфейс, оповещения и субтитры на **английский, испанский, португальский (Бразилия), французский, немецкий, арабский, японский, упрощённый китайский, корейский и русский** (10 языков). Следует системной локали или ручному выбору в приложении.
