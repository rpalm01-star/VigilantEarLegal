...
Предупреждения об опасной погоде поступают из **53 официальных государственных источников в 88 странах и территориях** — бесплатно для всех пользователей. Также поступают оповещения гражданской обороны Новой Зеландии — у них свой переключатель **Экстренные оповещения**. Набор лент сужается до тех, что охватывают ваше местоположение. В Японии приложение также читает **предварительные бюллетени** национальной метеослужбы — уведомления простым языком, которые выпускаются за несколько дней до тайфуна или сильного дождя, а не только предупреждения, выпускаемые, когда опасность уже наступила, — а также бюллетени о внезапных ливнях и оползнях. Предварительные уведомления показываются тихо, без звука и вибрации, которые приберегаются для настоящего предупреждения.
...
- **Оповещения о землетрясениях (по всему миру)** — когда поблизости зарегистрировано землетрясение, вы почувствуете вибрацию и увидите на карте область, где его ощутили. Это подтверждение из официальной сейсмической ленты, а не раннее предупреждение: если вы почувствовали толчки, оно скажет, что это было. Обнаружение «глубоких грохотов» (инфразвука) на устройстве может привести проверку в готовность в тот момент, когда земля приходит в движение.
...
graph LR
    ...
    W --> N["Официальные публичные ленты<br/>53 метеоисточника · 88 стран и территорий<br/>Гражданская оборона NZ · землетрясения"]
```
...
**Источники и лицензии:** [api.vigilantear.com/sources](https://api.vigilantear.com/sources)
