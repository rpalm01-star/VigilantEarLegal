...
*Действует с версии 1.1.8 · сентябрь 2026.*
...
**Грубые слова можно скрывать** (Настройки → Субтитры). Иначе они попадают в субтитры обычным текстом, и ничто не смягчает удар, а читающий не успевает отвести взгляд; включите это — и такие слова заменяются символами, так что фраза читается и без слова. Что считать грубым, решает распознаватель речи вашего устройства, а не наш список слов, поэтому он следует языку расшифровки. В учётной записи, заявленной как несовершеннолетняя, это включено всегда и показывает замок. Действует на речь, которую расшифровывает *это* устройство; текст, переданный со связанного телефона, был расшифрован там и приходит готовым.

**Слово, на которое говорящий сделал упор, выделяется полужирным.** Вслух «я ЭТОГО не говорил» и «я этого не говорил» — два разных предложения, а одинаковая расшифровка теряет разницу полностью. Приложение находит единственное слово, которое голос поднял по высоте тона, и выделяет его — не более одного в строке и ни одного, когда уверенности нет, потому что отметить не то слово значит приписать человеку чужие слова. Отключено в китайском и японском, где высота тона указывает, *какое это слово*, а не силу нажима.
...
Погода и оповещения о землетрясениях идут противоположным путём от аудио — ваш звук никогда не уходит наружу, но *данные* оповещений приходят. **Каждая** официальная лента проходит через небольшой кэш, который мы ведём, так что один запрос публичных данных обслуживает всех пользователей — и ваш телефон никогда не обращается к серверам иностранного правительства:
...
Подробности: [PRIVACY.md](/ru/privacy/) · [TERMS.md](/ru/terms/) · [SUPPORT.md](/ru/support/)
...
Полностью локализованы интерфейс, оповещения и субтитры на **английский, испанский, португальский (Бразилия), французский, немецкий, итальянский, турецкий, арабский, японский, упрощённый китайский, корейский, русский и хинди** (13 языков). Следует системной локали или ручному выбору в приложении.
