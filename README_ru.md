...
Предупреждения о суровой погоде приходят из официальных публичных лент CAP — **NWS** (США), **MeteoGate** (Европа), **CMA** (Китай) и **KMA** (Корея) — бесплатно для всех. Ленты сужаются до тех, что покрывают ваше местоположение.
...
- **CAP суровой погоды** — NWS, MeteoGate, CMA, KMA для вашего региона.
