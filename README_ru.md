...
Предупреждения об опасной погоде поступают из **53 официальных государственных источников в 88 странах и территориях** — бесплатно для всех пользователей. Также поступают оповещения гражданской обороны Новой Зеландии — у них свой переключатель **Экстренные оповещения**. Источники, лицензии которых требуют указания авторства, перечислены в разделе «Источники данных» в конце страницы. Набор лент сужается до тех, что охватывают ваше местоположение. В Японии приложение также читает **предварительные бюллетени** JMA — уведомления простым языком, которые выпускаются за несколько дней до тайфуна или сильного дождя, а не только предупреждения, выпускаемые, когда опасность уже наступила, — а также бюллетени о внезапных ливнях и оползнях. Предварительные уведомления показываются тихо, без звука и вибрации, которые приберегаются для настоящего предупреждения.
...
- **Оповещения об опасной погоде** — официальные предупреждения для вашего региона из 53 государственных источников в 88 странах и территориях.
...
graph LR
    ...
    W --> N["Официальные публичные ленты<br/>53 метеоисточника · 88 стран и территорий<br/>Гражданская оборона NZ · землетрясения USGS"]
```
...
Некоторые официальные источники публикуют свои предупреждения по открытым лицензиям, которые требуют указания авторства:

- **Мексика** — Servicio Meteorológico Nacional (CONAGUA), CC BY 4.0
- **Аргентина** — Servicio Meteorológico Nacional (Argentina), CC BY 4.0
- **Германия** — Quelle: Länderübergreifendes Hochwasserportal (LHP), www.hochwasserzentralen.de, CC BY 4.0
- **Новая Зеландия** — National Emergency Management Agency (NEMA), CC BY 4.0
- **Европа** — EUMETNET MeteoAlarm via MeteoGate, meteoalarm.org
