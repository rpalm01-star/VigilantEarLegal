...
O Aplicativo pode não detectar todos os sons, e as estimativas direcionais são aproximadas. **Sempre use sua própria confirmação visual e julgamento.** Nunca confie exclusivamente neste Aplicativo para sua segurança.

## 4. Sem Garantia

O APLICATIVO É FORNECIDO "COMO ESTÁ" E "CONFORME DISPONÍVEL", SEM QUAISQUER GARANTIAS DE QUALQUER TIPO, EXPRESSAS OU IMPLÍCITAS, INCLUINDO, MAS NÃO SE LIMITANDO A, GARANTIAS DE COMERCIALIZAÇÃO, ADEQUAÇÃO A UM DETERMINADO FIM E NÃO VIOLAÇÃO.

NÃO GARANTIMOS QUE O APLICATIVO SERÁ ININTERRUPTO, LIVRE DE ERROS OU TOTALMENTE PRECISO.
...
- Não depender do Aplicativo como seu único meio de percepção situacional
...
Nós nos reservamos o direito de rescindir ou suspender seu acesso ao Aplicativo a qualquer momento, com ou sem aviso prévio, por qualquer motivo.

## 9. Lei Aplicável

Estes Termos serão regidos e interpretados de acordo com as leis do Estado da **Flórida**, sem levar em conta suas disposições sobre conflitos de leis.

## 10. Alterações nos Termos

Podemos atualizar estes Termos de tempos em tempos. Notificaremos os usuários sobre alterações materiais atualizando a Data de Vigência acima. Seu uso contínuo do Aplicativo após tais alterações constitui aceitação dos novos Termos.
