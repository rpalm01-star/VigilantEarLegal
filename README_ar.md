...
تطبيق صُمم خصيصًا لمجتمع الصم وضعاف السمع وأبناء الصم (CODA). معظم تطبيقات التعرف على الصوت تخبرك *ما هو* الصوت. **Vigilant Ear يخبرك بمكانه، ومن يصدره، وماذا يقولون** — محولًا جهاز iPhone إلى جهاز قياس صوتي حيوي يصف الصوت من حولك.
...
- 👁️ **مصنوع للصم / ضعاف السمع / CODA.** استجابة لمسية مميزة، ومرئيات عالية التباين، وإشارات مستقلة عن اللون، وأهداف نقر كبيرة، واحترام خيار تقليل الحركة (Reduce Motion) في كل مكان.

---

## لمن هذا

- **المستخدمون الصم وضعاف السمع وCODA** الذين يريدون الوعي الظرفي بالصوت — مراقبة المنزل (طرقة، إنذار، طفل، هاتف) ومراقبة الشارع (صفارة إنذار، اقتراب) يمكنك تركها والوثوق بها.
...
يحدد مُصنف على الجهاز مئات الأصوات اليومية ويراقب الفئات الحرجة — **صفارات الإنذار، والإنذارات — بما في ذلك فئة مخصصة لإنذار السيارات —، وأجراس الأبواب/الطرقات، وبكاء الأطفال، والأشخاص القريبين، والطقس القاسي.** عندما ينطلق أحدها، تحصل على تنبيه واضح على الشاشة، و **إشعار دفع (push notification)** اختياري، و **استجابة لمسية** مميزة — حتى عندما يكون التطبيق في الخلفية أو الهاتف في وضع السكون. الفئات الحرجة تكون جاهزة افتراضيًا لذا تمكين الإشعارات لا يعني "إيقاف كل شيء". أوقف تشغيل جميع فئات التنبيهات وسينام المحرك تمامًا أثناء وجوده في الخلفية لتوفير البطارية. تقوم طبقة **Sentinel** بمطابقة التنبيهات مع أدلة مستقلة — الاتجاه والحركة والخلاصات العامة — بحيث يكون ما ينطلق مُعزَّزًا بالأدلة، وليس تخمين مُصنف واحد منعزل.

تأتي تحذيرات الطقس القاسي من الخلاصات العامة الرسمية — **NWS** في الولايات المتحدة، و **MeteoGate** في أوروبا، و **CMA** في الصين، و **KMA** في كوريا، و **JMA** في اليابان، و **ECCC** في كندا، و **INMET** في البرازيل — مجانًا لجميع المستخدمين. تقتصر الخلاصات على تلك التي تغطي مكان تواجدك.
...
- **تنبيهات الشركاء على معصمك** — عندما يُطلق هاتف شريك Constellation مرتبط تنبيهًا، يمكن أن يصل أيضًا إلى ساعتك Watch، مع الاتجاه. كما أن تحسينًا في الموثوقية يُبقي التطبيق المرافق خفيفًا على بطارية الساعة طوال اليوم.

### 💬 وضع المتحدث — تعليقات حية واتجاهية *(مجاني)*
قم بتشغيل **وضع المتحدث (Speaker Mode)** ويقوم Vigilant Ear بنسخ كلام الأشخاص الذين يتحدثون بالقرب منك إلى **كتل تعليقات، واحدة لكل صوت.** تحافظ يوميات المتحدث على الجهاز على تميز الأصوات — *من* يقول *ماذا* — مع إشارة اتجاهية على الحلقة الداخلية. يتم إبراز المتحدث الحي؛ وتتلاشى النصوص القديمة كلما كانت هناك حاجة إلى مساحة. التعليقات التوضيحية مجانية؛ الترجمة التلقائية هي طبقة Power Pack+ الاختيارية. يمكن أيضًا **نطق التعليقات بصوت عالٍ عبر أجهزة السمع بتقنية Bluetooth** — مجانًا، من التفضيلات.
...
هذا أقرب ما وصلنا إليه من **المترجم الكوني** في الخيال العلمي — الجهاز الذي يفهم ببساطة. Vigilant Ear يكتشف اللغة بنفسه، ويتابع كل متحدث في الغرفة، ويعرض ترجمة نصية للجميع بلغتك — دون سماعات، ودون إعداد، وعلى جهازك مباشرة.

```mermaid
graph LR
    A["فقط استمع"] --> B["كشف اللغة تلقائيًا"] --> C["فصل كل الأصوات"] --> D["ترجمة نصية للغرفة كلها بلغتك"]
```

### 🎵 الموسيقى والوعي بالبث *(Power Pack+)*
يحدد **ShazamKit** الموسيقى التي يتم تشغيلها من حولك ويتتبع تغييرات الأغاني.

### 🎛️ النطاق الصوتي — شاهد الصوت كمهندس
عرض احترافي مباشر للصوت من حولك: الطيف، والمخطط الطيفي، ونطاقات RTA بثلث أوكتاف، والكروما، والتوافقيات الجزئية — **مجاناً للجميع**. أما أدوات التقاط الأصوات لتدريب حزمك الخاصة فهي ضمن Power Pack+.
...
مع جهازين أو أكثر من أجهزة iPhone التي تدعم النطاق فائق العرض (معظمها منذ iPhone 11)، يقوم **Constellation** بإقرانها حتى تتمكن من استشعار موقع بعضها البعض ودمج ما يسمعه كل منها في صورة واحدة أكثر دقة عن المكان الذي يأتي منه الصوت — مصفوفة استماع سلبية وموزعة. تتصل الهواتف **ببعضها البعض مباشرةً** — بدون راوتر، وبدون شبكة Wi-Fi مشتركة، وبدون إنترنت؛ يكفي أن يكون Wi-Fi قيد التشغيل، عبر الرابط النظير-للنظير نفسه الذي يستخدمه AirDrop. يقتصر على الأجهزة التي تحتوي على الأجهزة المناسبة. لا يتم إعادة إرسال تعليقات الشبكة الأقدم من وقت اتصال النظير.

**رسائل الشركاء** — أرسل نصًا قصيرًا إلى هاتف شريك مرتبط؛ يظهر في موجز التسميات التوضيحية لديه ويمكن أن يصل مترجمًا إلى لغته، على الجهاز نفسه. المراسلة تراعي العمر: استنادًا إلى النطاق العمري المُعلن من Apple، تظل المراسلة بين شخص بالغ وقاصر معطلة ما لم يقم كلاهما بتسمية الآخر عمدًا. لا يتم أبدًا تقييد التنبيهات أو التسميات التوضيحية — فقط الرسائل من شخص إلى شخص.
...
- **تعليقات حية** — Speaker Mode، على الجهاز، اتجاهية حيثما تسمح الأجهزة، مع إخراج صوتي اختياري إلى أجهزة السمع بتقنية Bluetooth.
- **Standing Watch** — حالة الغرفة نفسها، يعمل دائمًا دون أي إعداد: مصباح سماوي (cyan) ثابت ما دامت الغرفة محافظة على نمطها، وكهرماني عندما يتغير شيء — صوت جديد، أو هدوء مفاجئ، أو شيء يقترب.
- **تنبيهات الطقس القاسي** — NWS، MeteoGate، CMA، KMA، JMA (اليابان)، ECCC (كندا)، INMET (البرازيل) لمنطقتك.
- **تنبيهات الزلازل (USGS، عالميًا)** — تشعر باهتزاز وترى على خريطتك المنطقة التي شعرت بالهزّة عند الإبلاغ عن زلزال قريب. تأكيد من خلاصة USGS الرسمية — وليس إنذارًا مبكرًا: إذا شعرت بالاهتزاز، فهذا يخبرك بما كان. ويمكن لاستشعار الهدير العميق (دون الصوتي) على الجهاز تفعيل التحقق لحظة تحرك الأرض.
...
- **النطاق الصوتي** — تصوير صوتي مباشر بمستوى احترافي، مجاناً للجميع. (أدوات الالتقاط للتدريب ضمن Power Pack+.)
...
- **Constellation** — استماع مشترك عبر هواتف iPhone متعددة باستخدام النطاق فائق العرض (Ultra-Wideband)، مع رسائل الشركاء.
...
- **iPad (أصلي).** تخطيط متكيّف: على الشاشة الكبيرة تحصل الترجمات الحية على لوحة شفافة بجانب الخريطة تختفي عندما لا يتحدث أحد. ميكروفونات أحادية القناة ← تعليقات توضيحية بدون اتجاه كامل.
- **Constellation** يحتاج إلى **نطاق فائق العرض (Ultra-Wideband)** — iPhone 11 أو أحدث، باستثناء طرازات SE و "e". ولا يحتاج إلى شبكة Wi-Fi: مع تشغيل Wi-Fi تكتشف الهواتف بعضها مباشرةً، لذا يعمل Constellation بدون راوتر وبدون إنترنت ما دامت الهواتف قريبة من بعضها.
...
**إصدار App Store الحالي:** 1.1.2. مصمم لأنظمة iOS الحديثة (عصر SpeechAnalyzer).

---

## الترجمة / التوطين

مترجم بالكامل — الواجهة، والتنبيهات، والتعليقات التوضيحية — إلى **الإنجليزية، والإسبانية، والبرتغالية (البرازيل)، والفرنسية، والألمانية، والعربية، واليابانية، والصينية المبسطة، والكورية، والروسية، والإيطالية** (11 لغة). يتبع لغة النظام أو الاختيار اليدوي في التطبيق.
