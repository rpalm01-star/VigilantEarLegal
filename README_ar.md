...
تأتي تحذيرات الطقس القاسي من الخلاصات العامة الرسمية — **NWS** في الولايات المتحدة، و **MeteoGate** في أوروبا، و **CMA** في الصين، و **KMA** في كوريا، و **JMA** في اليابان، و **ECCC** في كندا — مجانًا لجميع المستخدمين. تقتصر الخلاصات على تلك التي تغطي مكان تواجدك.
...
- **تنبيهات الطقس القاسي** — NWS، MeteoGate، CMA، KMA، JMA (اليابان)، ECCC (كندا) لمنطقتك.
...
**إصدار App Store الحالي:** 1.0.17. مصمم لأنظمة iOS الحديثة (عصر SpeechAnalyzer).

---

## الترجمة / التوطين

مترجم بالكامل — الواجهة، والتنبيهات، والتعليقات التوضيحية — إلى **الإنجليزية، والإسبانية، والبرتغالية (البرازيل)، والفرنسية، والألمانية، والعربية، واليابانية، والصينية المبسطة، والكورية، والروسية** (10 لغات). يتبع لغة النظام أو الاختيار اليدوي في التطبيق.
