...
- **رفيق Apple Watch** — يشير اتجاه التنبيه على معصمك لذا تخبرك النظرة السريعة أين تنظر. واجهة مستخدم Watch معاد تصميمها مع أيقونة أذن التطبيق، وتخطيط شاشة التهديدات (HUD)، والنقر المزدوج للتصغير. يمكن للتنبيهات أن تستمر في إظهار سهم الاتجاه عندما لا يكون تطبيق Watch مفتوحًا.
...
### 🪄 ساحة التدريب — أثبت ذلك بدون آذان
**وضع ساحة اللعب (Playground Mode)** متاح للجميع: تدريب المنزل والشارع (طرقة، إنذار، طفل، صفارة إنذار، طقس)، والعروض التوضيحية للمحادثات والهواتف المتعددة، وعلامة مائية واضحة بحيث لا يتظاهر التدريب أبدًا بأنه حدث حقيقي. إغلاق اللوحة يزيل العروض التوضيحية بنظافة (لا يوجد انتحال عالق لنظام تحديد المواقع العالمي، ولا علامات متبقية).
...
- **Demo Mode** — ممارسة التنبيهات ومعاينة الميزات بعلامة مائية DEMO.
...
**إصدار تسويق Apple الحالي:** 1.0.7 (قيد التقدم / مسار الشحن). مصمم لأنظمة iOS الحديثة (عصر SpeechAnalyzer).
